function CBGTextButton(iXPos, iYPos, iW, iH, oSprite, szText, szFont, szColor, iFontSize, oContainer) {
    var _aParams;
    var _aCbCompleted;
    var _aCbOwner;
    var _oButton;
    ...
    this._init = function (iXPos, iYPos, iW, iH, oSprite, szText, szFont, szColor, iFontSize) {
        _aParams = new Array();
        ...
        var iX = oSprite.width;
        var iY = Math.floor((oSprite.height));
        oButtonBg.scaleX = iW / iX;
        oButtonBg.scaleY = iH / iY;
        var iWidth = iX;
        var iHeight = iY;
        ...
        _oText = new CTLText(_oContainer,
            iXPos - 33, iYPos - 28, iW, iH,
            25, "center", szColor, szFont, 1,
            2, 2,
            szText,
            true, true, true,
            false);
    ...
    this._init(iXPos, iYPos, iW, iH, oSprite, szText, szFont, szColor, iFontSize);
