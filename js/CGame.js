function CGame(oData) {
    ...
    this.initNewBestScoreText = function () {
        ...
        _oNewBestScoreText = new CTLText(_oGameContainer,
            // iX - iWidth / 2 - 156, iY - iHeight / 2 - 300, iWidth, iHeight,
            iX - iWidth / 2, iY - iHeight / 2 - 300, iWidth, iHeight,
    ...
    this.initNewStarBonus = function () {
        ...
        // _oStarBonus = new CBonus(CANVAS_WIDTH_HALF - 156, CANVAS_HEIGHT_HALF - 420, _oGameContainer, iIndex);
        _oStarBonus = new CBonus(CANVAS_WIDTH_HALF, CANVAS_HEIGHT_HALF - 200, _oGameContainer, iIndex);
    };
    ...
    this.setNextStartPosition = function () {
        ...
        if (_iScore < RANDOM_BALL_START_LIMIT) {
            // _oBallStartPosition.x = CANVAS_WIDTH_HALF - 156;
            _oBallStartPosition.x = CANVAS_WIDTH_HALF;
        } else {
            _oBallStartPosition.x = Math.random() * (CANVAS_WIDTH - 400 - 100) + 100;
        }
